...
<body>
    <div class="contents">
        <div class="contents-container">
            <form action="Housing_support_create_file.php" method="POST" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div>
                        <label for="image" class="textfield_label">画像データアップ</label>
            ...
            <footer>
                <div class="footer-container">
                    <p>©G's 福岡dev8 課題10 naohiro.mada</p>
                </div>
            </footer>
        </div>
    </div>
